...
class AudioTransportImpl : public AudioTransport {
 ...
 private:
  void processMixStreamWithGc(AudioFrame* audioFrame);
  // Shared.
  ...
  std::unique_ptr<GainControlImpl> gain_control_ = nullptr;
  std::unique_ptr<AudioBuffer> gc_buffer_ = nullptr;
  AudioFrame gc_frame_;
