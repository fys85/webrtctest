...
bool BaseChannel::SendPacket(bool rtcp,
  ...
  // Bon voyage.
  bool ret = rtcp ? rtp_transport_->SendRtcpPacket(packet, options, PF_SRTP_BYPASS)
                  : rtp_transport_->SendRtpPacket(packet, options, PF_SRTP_BYPASS);
  if (ret && !has_send_packet_) {
      SignalFirstPacketSend_(this);
      has_send_packet_ = true;
  }
  return ret;
}
...
void BaseChannel::ResetFirstPacketRecvSignal() {
