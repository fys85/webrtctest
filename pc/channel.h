...
class BaseChannel : public ChannelInterface,
 ...
 public:
  ...
  // Used for latency measurements.
  sigslot::signal1<ChannelInterface*>& SignalFirstPacketSend() override {
      return SignalFirstPacketSend_;
  }
  ...
  void ResetFirstPacketRecvSignal() override;
 ...
 private:
  ...
  bool has_send_packet_ = false;
  sigslot::signal1<ChannelInterface*> SignalFirstPacketSend_;
};
