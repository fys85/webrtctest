...
ScopedJavaLocalRef<jobject> NativeToJavaDegradationPreference(
  ...
  return Java_DegradationPreference_fromNativeIndex(jni, (jint)degradationPreference);
}

DegradationPreference JavaToNativeDegradationPreference(JNIEnv* jni,
  const JavaRef<jobject>& j_degradation_prefence) {
  return static_cast<DegradationPreference>(
    Java_DegradationPreference_getNative(jni, j_degradation_prefence));
}
...
RtpParameters JavaToNativeRtpParameters(JNIEnv* jni,
  ...
  parameters.degradation_preference = JavaToNativeDegradationPreference(jni,
...
ScopedJavaLocalRef<jobject> NativeToJavaRtpParameters(
  ...
  return Java_RtpParameters_Constructor(
      ...
      NativeToJavaDegradationPreference(env, parameters.degradation_preference));
}
