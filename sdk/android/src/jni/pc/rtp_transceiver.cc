...
void JNI_RtpTransceiver_ResetFirstPacketRecvSignal(JNIEnv* jni,
        jlong j_rtp_transceiver_pointer) {
  reinterpret_cast<RtpTransceiverInterface*>(j_rtp_transceiver_pointer)->ResetFirstPacketRecvSignal();
}
