...
public class DefaultVideoEncoderFactory implements VideoEncoderFactory {
  ...
  private final VideoEncoderFactory externalVideoEncoderFactory = new EncodedVideoEncoderFactory();
  ...
  public VideoEncoder createEncoder(VideoCodecInfo info) {
    if (info.params.containsKey("is_encoded") && info.params.get("is_encoded").equals("true")) {
        return externalVideoEncoderFactory.createEncoder(info);
    }
...
//    supportedCodecInfos.addAll(Arrays.asList(externalVideoEncoderFactory.getSupportedCodecs()));
