...
public class RtpParameters {
  ...
  // Must be kept in sync with DegradationPreference.
  public enum DegradationPreference {
    ...
    DegradationPreference(int nativeIndex) {
    ...
    static DegradationPreference fromNativeIndex(int nativeIndex) {
      for (DegradationPreference type : DegradationPreference.values()) {
        if (type.getNative() == nativeIndex) {
          return type;
        }
      }
      throw new IllegalArgumentException("Unknown native degradation preference: " + nativeIndex);
    }
  }
