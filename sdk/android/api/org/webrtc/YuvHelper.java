...
public class YuvHelper {
  ...
  public static void I420ToJPEG(ByteBuffer srcY, int yStride, ByteBuffer srcU, int uStride, ByteBuffer srcV, int vStride,
                                  Object callback, int quality, int width, int height) {
      nativeI420ToJPEG(srcY, yStride, srcU, uStride, srcV, vStride, callback, quality, width, height);
  }

  public static void I420Scale(ByteBuffer srcY, int yStride, ByteBuffer srcU, int uStride, ByteBuffer srcV, int vStride,
                                 int srcWidth, int srcHeight, ByteBuffer dst, int dstWidth, int dstHeight) {
      nativeI420Scale(srcY, yStride, srcU, uStride, srcV, vStride, srcWidth, srcHeight, dst, dstWidth, dstHeight);
  }

  public static void I420Mirror(ByteBuffer srcY, int srcStrideY, ByteBuffer srcU,
       ...
       nativeI420Mirror(srcY, srcStrideY, srcU, srcStrideU, srcV, srcStrideV, dstY, dstStrideY,
  ...
  private static native void nativeI420Rotate(ByteBuffer srcY, int srcStrideY, ByteBuffer srcU,
      ...
      int rotationMode);
  private static native void nativeI420ToJPEG(ByteBuffer srcY, int yStride, ByteBuffer srcU, int uStride, ByteBuffer srcV, int vStride, Object callback, int quality, int width, int height);

  private static native void nativeI420Scale(ByteBuffer srcY, int yStride, ByteBuffer srcU, int uStride, ByteBuffer srcV, int vStride,
                                             int srcWidth, int srcHeight, ByteBuffer dst, int dstWidth, int dstHeight);
  private static native void nativeI420Mirror(ByteBuffer srcY, int srcStrideY, ByteBuffer srcU,
      int srcStrideU, ByteBuffer srcV, int srcStrideV, ByteBuffer dstY, int dstStrideY,
      ByteBuffer dstU, int dstStrideU, ByteBuffer dstV, int dstStrideV, int width, int height);
}
