...
public class JavaAudioDeviceModule implements AudioDeviceModule {
  ...
  public static class Builder {
    ...
    private boolean useCustomAudioRecord = false;
    ...
    public Builder setCustomAudioRecord(boolean enable) {
      this.useCustomAudioRecord = enable;
      return this;
    }
    ...
    public AudioDeviceModule createAudioDeviceModule() {
      ...
      final CustomAudioRecord customAudioInput = new CustomAudioRecord(inputSampleRate, useStereoInput ? 2 : 1);
      ...
      return new JavaAudioDeviceModule(context, audioManager, audioInput, useCustomAudioRecord ? customAudioInput: null, audioOutput,
  ...
  private final CustomAudioRecord customAudioInput;

  private final Object nativeLock = new Object();
  private long nativeAudioDeviceModule;

  private JavaAudioDeviceModule(Context context, AudioManager audioManager,
      WebRtcAudioRecord audioInput, CustomAudioRecord customAudioInput, WebRtcAudioTrack audioOutput, int inputSampleRate,
    ...
    this.useStereoInput = useStereoInput;
    this.useStereoOutput = useStereoOutput;
    this.customAudioInput = customAudioInput;
  }
  ...
  public long getNativeAudioDeviceModulePointer() {
    synchronized (nativeLock) {
      if (nativeAudioDeviceModule == 0) {
        nativeAudioDeviceModule = nativeCreateAudioDeviceModule(context, audioManager, audioInput, customAudioInput,
  ...
  private static native long nativeCreateAudioDeviceModule(Context context,
      AudioManager audioManager, WebRtcAudioRecord audioInput, CustomAudioRecord customAudioInput, WebRtcAudioTrack audioOutput,
